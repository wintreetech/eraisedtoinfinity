...
export function calculateVRIFromAnswers(answerArray) {
  ...
  if (VRI <= 40) {
    ...
    interpretation = "Business not valuation-ready. Needs fundamentals, systems, and structure.";
  } else if (VRI <= 60) {
    category = "Structured Stage";
    interpretation = "Needs systems, compliance, and team upgrades to scale.";
  } else if (VRI <= 80) {
    category = "Scalable Stage";
    interpretation = "High potential; consider capital and advisory to accelerate growth.";
  } else {
